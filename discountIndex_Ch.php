    ...
    <div class="my-3">
      ...
      <div class="d-flex justify-content-end mb-4">
        <div class="btn-group me-2">
          ...
          <ul class="dropdown-menu">
            <?php for ($i = 10; $i <= 50; $i += 10) : ?>
              <li><a class="dropdown-item" href="discountIndex_Ch.php?<?php if (isset($type)) {
                                                                        echo "type=$type";
                                                                      } ?>&countPerPage=<?= $i ?>"><?= $i ?></a></li>
            <?php endfor; ?>
          </ul>
        </div>
        <div class="btn-group float-end">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="discountIndex_Ch.php?<?php if (isset($countPerPage)) {
                                                                      echo "countPerPage=$countPerPage";
                                                                    } ?>&type=1">id升冪</a></li>
            <li><a class="dropdown-item" href="discountIndex_Ch.php?<?php if (isset($countPerPage)) {
                                                                      echo "countPerPage=$countPerPage";
                                                                    } ?>&type=2">id降冪</a></li>
        ...
        <tbody>
          <?php foreach ($rows as $row) : ?>
            <tr>
              ...
              <td class="text-center <?php if ($row["enable"] == 1) {
                                        echo "text-success";
                                      } else {
                                        echo "text-danger";
                                      } ?>">
      ...
      <ul class="pagination">
        ...
        <?php for ($i = 1; $i <= $totalPageCount; $i++) : ?>
          <li class="page-item <?php if ($page == $i) {
                                  echo "active";
                                } ?>"><a class="page-link" href="discountIndex_Ch.php?page=<?= $i ?> &<?php if (isset($type)) {
                                                                                                        echo "type=$type";
                                                                                                      } ?>&<?php if (isset($countPerPage)) {
                                                                                                              echo "countPerPage=$countPerPage";
                                                                                                            } ?>"><?= $i ?></a>
